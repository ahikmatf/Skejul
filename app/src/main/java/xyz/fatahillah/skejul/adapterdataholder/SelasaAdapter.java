 ...
 */
public class SelasaAdapter extends RecyclerView.Adapter<JadwalViewHolder> {

    String[] selasa = {"Selasa 1", "Kuliah 2", "Kuliah 3", "Kuliah 4", "Kuliah 5", "Kuliah 6", "Kuliah 7", "Kuliah 8", "Kuliah 9", "Kuliah 10", "Kuliah 11"};
...
//            int position = vholder.getPosition();
    ...
    public SelasaAdapter(Activity context) {
    ...
    public void onBindViewHolder(JadwalViewHolder holder, int position) {
        ...
        holder.tv1.setText(selasa[position]);
